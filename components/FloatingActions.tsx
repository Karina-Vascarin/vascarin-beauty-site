...
export default function FloatingActions() {
  ...
  // Garante que a hidratação aconteça corretamente para evitar erros
  useEffect(() => {
    setIsMounted(true);
  }, []);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 items-end">
      ...
      {/* Botão Flutuante do WhatsApp (ÚNICO RESTANTE) */}
      <button 
        onClick={handleWhatsAppClick}
        className="relative bg-green-500 text-white w-14 h-14 rounded-full shadow-[0_4px_14px_rgba(0,0,0,0.25)] hover:bg-green-600 hover:scale-105 transition-all flex items-center justify-center cursor-pointer"
